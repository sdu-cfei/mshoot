"""Parameter estimation for the model used in Case 3"""
import os
...
res_dir = os.path.join('examples', 'bs2019', 'case3', 'results', 'est')
...
session = modestpy.Estimation(res_dir, fmu, inp, known, est, ideal,
    lp_n = 1,
...
esrel.to_csv(os.path.join(res_dir, 'parameters_rel.csv'), index=False)
